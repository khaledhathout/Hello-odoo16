...
``` bash
curl -s https://raw.githubusercontent.com/khaledhathout/Hello-odoo16/master/run.sh | sudo bash -s odoo-one 10016 20016
```
...
``` bash
curl -s https://raw.githubusercontent.com/khaledhathout/Hello-odoo16/master/run.sh | sudo bash -s odoo-two 11016 21016
```
...
``` sh
$ git clone https://github.com/khaledhathout/Hello-odoo16.git
